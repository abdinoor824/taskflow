        ...
        <div className="w-full max-w-md bg-[#FAF9F6] rounded-3xl shadow-xl p-8">
          ...
          {/* <div className="flex mb-6 gap-2">
            <input
              ...
              className="flex-1 bg-transparent border-b border-gray-200 py-2 text-sm outline-none focus:border-gray-400"
            />
            <button
              onClick={handleCreate}
              className="shrink-0 bg-[#F5C242] text-gray-900 text-sm font-semibold px-4 rounded-full hover:brightness-95"
            >
              Add
            </button>
          </div> */}
...
<p className={`text-sm font-semibold break-words ${task.completed ? 'line-through text-gray-400' : 'text-gray-900'}`}>                    {task.title}
                  </p>
                </div>
